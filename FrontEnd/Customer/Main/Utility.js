...
function navigateToDeleteCustomer() {
    window.location.href = "../Delete/DeleteCustomer.html";
};

function navigateToUpdateInformation() {
    window.location.href = "../Update/UpdateCustomer.html";
};
