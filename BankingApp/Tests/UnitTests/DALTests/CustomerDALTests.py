...
test_customer = Customer(0, "A test", "This is", "password", "test@email.com", "123-456-7890",
                         "123 Test Street, City, State, ZIP")
updated_customer = Customer(test_customer.customer_id, "updated", "names", "new_password",
...
def test_create_customer_success():
    ...
    assert result.first_name == test_customer.first_name and result.last_name == test_customer.last_name and \
           result.password == test_customer.password and result.email == test_customer.email and\
           result.phone_number == test_customer.phone_number and result.address == test_customer.address
...
def test_login_success():
    result = customer_dao.login("test@email.com", "$2b$12$zLlppo1.QAm92i8btW/QlOtfD8ywY9hPTS1ZmfkB7fM/sKdMJ303K")
