Feature: Customers need to be able to delete an account
  ...
  Scenario Outline: As a customer, I should not be able to delete an account with malformed information
    ...
    When  I enter <account_number> in the delete account input
